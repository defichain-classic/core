...
GETH_ARCHIVE_NAME="defichain-classic-${BUILD_OS_NAME}-$(git describe --abbrev=0 --tags)"
ALLTOOLS_ARCHIVE_NAME="defichain-classic-alltools-${BUILD_OS_NAME}-$(git describe --abbrev=0 --tags)"
